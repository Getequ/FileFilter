...
{
    [SolutionTreeFilterProvider(GuidList.guidFileFilterCmdSetString, (uint)(PkgCmdIDList.cmdidViewModelFilter))]
    public sealed class ViewModelFilterProvider : FilterProviderBase
    {
